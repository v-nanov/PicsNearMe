...
SWIFT_CLASS("_TtC15LocationManager15LocationManager")
...
@property (nonatomic, copy) void (^ _Null_unspecified locationFound)(double, double);
@property (nonatomic, copy) void (^ _Nullable locationFoundGetAsString)(NSString * _Nonnull, NSString * _Nonnull);
@property (nonatomic, copy) void (^ _Nullable locationManagerStatus)(NSString * _Nonnull);
@property (nonatomic, copy) void (^ _Nullable locationManagerReceivedError)(NSString * _Nonnull);
@property (nonatomic, copy) void (^ _Nullable locationManagerVerboseMessage)(NSString * _Nonnull);
